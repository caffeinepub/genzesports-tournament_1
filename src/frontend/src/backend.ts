...
export class Backend implements backendInterface {
    ...
    async approveRegistration(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createTournament(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string): Promise<Tournament> {
        if (this.processError) {
            try {
    ...
    async disapproveRegistration(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.disapproveRegistration(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllRegistrations(arg0: bigint | null): Promise<Array<Registration>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRegistrations(to_candid_opt_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTournamentById(arg0: bigint): Promise<Tournament> {
        if (this.processError) {
            try {
    ...
    async submitRegistration(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string): Promise<Registration> {
        if (this.processError) {
            try {
    ...
    async updateTournamentStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTournamentStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
